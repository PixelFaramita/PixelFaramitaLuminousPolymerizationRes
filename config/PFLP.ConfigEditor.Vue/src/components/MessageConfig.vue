  ...
  <div>
      ...
      <n-h4 prefix="bar">
        ...
        <div v-if="popup.ModuleEnabled">
          <n-space>
            切换间隔<n-input-number
              step="250"
              v-model:value="popup.RefreshInterval"
            >
      ...
      <n-h4 prefix="bar">
        ...
        <div v-if="belowname.ModuleEnabled">
          <n-space>
            切换间隔<n-input-number
              step="250"
              v-model:value="belowname.RefreshInterval"
            >
              <template #suffix> 毫秒 </template>
            </n-input-number>
          </n-space>
      ...
      <n-h4 prefix="bar">
        ...
        <div v-if="sidebar.ModuleEnabled">
          <n-space>
            切换间隔<n-input-number
              step="250"
              v-model:value="sidebar.RefreshInterval"
            >
              <template #suffix> 毫秒 </template>
            </n-input-number>
          </n-space>
      ...
      <n-h4 prefix="bar">
        ...
        <div v-if="playerlist.ModuleEnabled">
          <n-space>
            切换间隔<n-input-number
              step="250"
              v-model:value="playerlist.RefreshInterval"
            >
              <template #suffix> 毫秒 </template>
            </n-input-number>
          </n-space>
      ...
      <n-h4 prefix="bar">
        ...
        <div v-if="motd.ModuleEnabled">
          <n-space>
            切换间隔<n-input-number
              step="250"
              v-model:value="motd.RefreshInterval"
            >
              <template #suffix> 毫秒 </template>
            </n-input-number>
          </n-space>
    ...
    <div v-if="disconnect.ModuleEnabled">
      <n-space>
        ...
        <n-switch
          size="large"
          v-model:value="disconnect.ShowDisconnectInConsole"
        />
      </n-space>
      <n-space>
        强制允许的协议版本
